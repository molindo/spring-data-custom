...
@Documented
@Inherited
@Import(CustomRepositoriesRegistrar.class)
public @interface EnableCustomRepositories {

	/**
	 * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation declarations e.g.:
	 * {@code @EnableCustomRepositories("org.my.pkg")} instead of
	 * {@code @EnableCustomRepositories(basePackages="org.my.pkg")} .
	 */
	 ...
	 * {@code META-INF/custom-named-queries.properties}.
	 *
	 * @return
	 */
	 ...
	 * {@link CustomRepositoryFactoryBean}.
	 *
	 * @return
	 */
	Class<?> repositoryFactoryBeanClass() default CustomRepositoryFactoryBean.class;
